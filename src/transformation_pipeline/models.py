...
def product_data_enriched(
        data=bauplan.Model('zlt.product_data'),
...
def top_selling_products(
        transaction_line_item=bauplan.Model('zlt.transaction_line_item'),
        product_data=bauplan.Model('product_data_enriched')
        # product_data=bauplan.Model('zlt.product_data')
):
    """
...
def top_selling_suppliers(
        ...
        supplier_sku_lookup=bauplan.Model('zlt.supplier_sku_lookup')
):
    """
